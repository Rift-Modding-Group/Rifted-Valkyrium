...
@Pseudo
@Mixin(targets = "nl.requios.effortlessbuilding.buildmode.ThreeClicksBuildMode", remap = false)
public abstract class MixinThreeClicksBuildMode {
    @ModifyVariable(method = "findHeight", at = @At("STORE"), index = 3, remap = false)
    ...
    @ModifyVariable(method = "findHeight", at = @At("STORE"), index = 4, remap = false)
