...
@Pseudo
@Mixin(targets = "nl.requios.effortlessbuilding.buildmode.buildmodes.Wall", remap = false)
public abstract class MixinWall {
    @ModifyVariable(method = "findWall", at = @At("STORE"), index = 3, remap = false)
    ...
    @ModifyVariable(method = "findWall", at = @At("STORE"), index = 4, remap = false)
